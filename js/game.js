...
function createLights() {
  ...
  hemisphereLight = new THREE.HemisphereLight(0x2C3E50 ,0x2C3E50 , .9)

  ambientLight = new THREE.AmbientLight(0x2C3E50, .5);
...
Sky = function(){
  ...
  for(var i=0; i<this.nClouds; i++){
    ...
    this.clouds.push(c);
    var a = stepAngle*i;
    var h = game.seaRadius + 150 + Math.random()*100;
...
Particle = function(){
  var geom = new THREE.CylinderGeometry(0, 4, 5, 4, 1);
  var mat = new THREE.MeshPhongMaterial({
    color:0x009999,
    shininess:0,
    specular:0xffffff,
...
function createPlane(){
  ...
  airplane.mesh.scale.set(.20,.20,.20);
